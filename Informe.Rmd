...
**4.	Resultats** Els resultats han de respondre a les preguntes plantejades. Sovint aquestes són obertes (ex. "Exploració de les dades") o admeten diferents interpretacions, així que podeu ser flexibles; però expliqueu sempre per què feu el que feu. Davant el dubte, consultau els materials i exemples de referència. (4-5 pàgines)
